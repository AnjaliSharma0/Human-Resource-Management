...
// import { BarChart3Icon, ChartBarIcon, DollarSignIcon, DownloadIcon, FlowerIcon, ListRestartIcon, LuggageIcon } from "lucide-react";
...
//     { name: "My Team", path: "/manager/team", icon: <PeopleIcon /> },
//     { name: "Attendance", path: "/attendance", icon: <EventIcon /> },
//     { name: "Leave Approvals", path: "/leave/manage", icon: <MoodSharp /> },
//     { name: "Expense Approvals", path: "/expenses", icon: <DollarSignIcon /> },
//     { name: "Performance", path: "/performance", icon: <BarChart3Icon /> },
//     { name: "Reports", path: "/manager/reports", icon: <PriorityHighOutlined /> },
...
//                 key={item.name}
//                 href={item.path}
//                 className={`flex items-center gap-3 p-2 rounded ${active ? "bg-indigo-500" : "hover:bg-indigo-600"
//                   }`}
//               >
//                 {item.icon}
//                 {!collapsed && item.name}
...
import EqualizerIcon from "@mui/icons-material/Equalizer";
import { BarChart3Icon, DollarSignIcon, DownloadIcon, FlowerIcon, ListRestartIcon } from "lucide-react";
...
export default function Sidebar() {
  ...
  const managerMenu = [
    ...
    { name: "Leave Approvals", path: "/leave/manage", icon: <MoodSharp /> },
    { name: "Expense Approvals", path: "/expenses", icon: <DollarSignIcon /> },
    { name: "Performance", path: "/manager/performance", icon: <BarChart3Icon /> },
    { name: "Reports", path: "/employees/reports", icon: <PriorityHighOutlined /> },
    { name: "HelpDesk", path: "/helpdesk", icon: <HelpCenterOutlined /> },
  ];
  ...
  ${collapsed ? (isMobile ? "-translate-x-full" : "w-20") : "w-64"}
`}
      >
        {/* Header */}
