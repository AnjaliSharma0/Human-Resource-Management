...
export default function EmployeeEditPage() {
  ...
  // Fetch employee, departments & designations
  useEffect(() => {
    if (!id) return;
    setAuthToken(token);
  ...
  if (userRole !== "admin" && employee.id !== userId) return <Box className="text-center mt-20">You are not allowed to edit this profile</Box>;
